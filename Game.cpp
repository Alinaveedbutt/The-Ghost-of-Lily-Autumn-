...
int main() {
    ...
    if (startStop == "yes") {
        ...
        cout<<endl;
        cout<<"You are a detective tasked with solving a chilling mystery"<<endl<<endl;
        ...
        cout<<endl;
        cout<<"Years ago, a tragedy struck at the Autumn Estate,";
        ...
        cout<<endl<<endl;
        cout<<"Now, as Detective "<<playerName<<", you have been called by the authorities to uncover the truth behind this mystery. The deeper you dive into the mystery, the more you realize that some tragedies refuse to stay buried."<<endl;
        cout<<endl;
        cout<<"Detective "<<playerName<<", the mystery awaits you..."<<endl<<endl;
        ...
        while (!caseSolved && !exitGame) {
            ...
            switch (choice) {
                case 1:
                cout<<endl;
                cout<<"You step into the abandoned house. Dust and cobwebs cover every corner of the house."<<endl;
                ...
                case 3:
                    cout<<endl;
                    cout<<"Exiting the game. You gave up way too early, Detective"<<endl<<"Final score: 0"<<endl<<"Total progress: 0%"<<endl;
                    cout<<endl;
                    cout<<"This game was inspired by Dark Dome's 'The Girl in the Window.' Thank you for playing!"<<endl;
                    caseSolved = true;
                    exitGame = true;
                    break;
                default:
...
void exploreHouse(vector<string> &inventory, bool &caseSolved) {
    ...
    switch (choice) {
        case 1:
            cout<<endl;
            cout<<"The door is locked. It seems you need a key to open it."<<endl;
            break;
        case 2:
            cout<<endl;
            cout<<"You move up the creaky stairs and see two doors ahead."<<endl;
        ...
        case 3:
            cout<<endl;
            cout<<"Exiting the game. You gave up early, Detective."<<endl;
            cout<<"Final score: 0"<<endl;
            cout<<"Total progress: 10%"<<endl;
            cout<<endl;
            cout<<"This game was inspired by Dark Dome's 'The Girl in the Window.' Thank you for playing!"<<endl;
            case2Solved = true;
            exit2Game = true;
...
void upstairs(vector<string> &inventory, bool &caseSolved) {
    ...
    switch (choice) {
        ...
        case 3:
            cout<<endl;
            cout<<"You returned to the main door"<<endl;
            exploreHouse(inventory, caseSolved);
            case3solved = true;
            exit3game = true;
            break;
...
void doorOne(vector<string> &inventory, bool &caseSolved) {
    cout<<endl;
    cout<<"You enter Door 1 and find yourself in a creepy room with peeling wallpaper and broken furniture."<<endl;
    string input;
    cout<<endl;
    cout<<"press A and ENTER to continue:";
    cin.ignore();
    getline(cin, input);
    cout<<endl;
    cout<<"Amidst the eerie silence, you notice a book on a dusty table."<<endl;
    cout<<endl;
    cout<<"press A and ENTER to continue:";
    cin.ignore();
    getline(cin, input);
    cout<<endl;
    cout<<"You approach the book and see that its titled 'Lily's Diary' and as you open the book, you find a key taped to a page with 'SECRET' written on it."<<endl;
    bool dooronewhile = false;
    while(!dooronewhile){
    string dooroneanswer;
        cout<<endl;
        cout<<"Do you want to take the diary and the key? (yes/no)"<<endl;
        cin>> dooroneanswer;
        if(dooroneanswer == "yes"){
        inventory.push_back("Lily's Diary");
        inventory.push_back("Key");
        cout<<endl;
            cout<<"You took the key and the diary with you."<<endl;
    dooronewhile = true;
    }
    else if(dooroneanswer == "no"){
        cout<<endl;
        cout<<"You did not took the key and the diary with you."<<endl;
        dooronewhile = true;
    }
    else{
...
void doorTwo(vector<string> &inventory, bool &caseSolved) {
    cout<<endl;
    cout<<"As you approach Door 2, you hear a whisper: 'Do not step ahead."<<endl;
    ...
    if (choice == 1) {
        cout<<endl;
        cout<<"As you step forward, the wooden floor gives way, and you fall through, meeting a tragic end."<<endl;
        cout<<"ENDING #1: You Died"<<endl;
        cout<<endl;
        cout<<"**** GAME OVER ****"<<endl;
        cout<<endl;
        cout<<"Total progress: 40%"<<endl;
        cout<<endl;
        cout<<"This game was inspired by Dark Dome's 'The Girl in the Window.' Thank you for playing!"<<endl;
    }
    else if (choice == 2) {
...
void downstairsRoom(vector<string> &inventory, bool &caseSolved) {
    ...
    cout<<endl;
        cout<<"You used the key to unlock the door downstairs."<<endl;
    ...
    if (choice == 1) {
        cout<<endl;
        cout<<"Inside the closet, you find a doll next to a locked box requiring a puzzle to solve."<<endl;
        ...
        if (inputShapes == vector<int>{2, 1, 3, 4}) {
            cout<<endl;
            cout<<"The box opens, revealing a key and a picture of a church."<<endl;
            ...
            cout<<endl;
                cout<<"The entered order is incorrect. Try again "<<endl;
        }}
    }
        else if(choice == 2) {
        cout<<endl;
            cout<<"You leave the room, but as you turn, a black shadow appears, and you pass out. You later wake up in a hopital, you survived but failed the mission";
            cout<<endl;
            cout<<"ENDING #2: Mission Failed"<<endl;
...
void finaldoor(vector<string> &inventory, bool &caseSolved)
{
    string rightdoor;
    cout<<endl;
    cout<<"As you were heading towards the main door you realise that there are now 3 main doors of different colors(red blue yellow respectively) and you need to choose one from them to leave the house!"<<endl<<endl;
    ...
    if(rightdoor == "1"){
        cout<<endl;
        cout<<"You chose the right door and has escaped!"<<endl;
        finalEnding(inventory);
    }
    else{
        cout<<endl;
        cout<<"As you enter, a creepy creature attacks you and you die!"<<endl;
        cout<<"ENDING #3: Wrong door"<<endl;
        cout<<endl;
        cout<<"**** GAME OVER ****"<<endl;
        cout<<endl;
        cout<<"Total progress: 80%"<<endl;
        cout<<endl;
        cout<<"This game was inspired by Dark Dome's 'The Girl in the Window.' Thank you for playing!"<<endl;
    }
}
void finalEnding(const vector<string> &inventory) {
    if (find(inventory.begin(), inventory.end(), "Lily's Diary") != inventory.end() &&find(inventory.begin(), inventory.end(), "Church Picture") != inventory.end()){
        ...
        cout<<endl;
        cout<<"With the evidence you found, you head to the police station."<<endl;
        ...
        cout<<endl;
        cout<<"The picture you found points to the cult members' church where the rituals were performed."<<endl;
        cout<<"Thanks to your investigation, the authorities apprehend the culprits, and Lily's story finally comes to light."<<endl;
        cout<<endl;
        cout<<"A few days later, you return to the abandoned house. As you look up, you see Lily's ghost smiling and waving at you from the window before disappearing."<<endl;
        cout<<endl;
        cout<<"Her soul is finally at peace."<<endl;
        cout<<endl;
        cout<<"ENDING #5: Justice Served!"<<endl;
        cout<<endl;
        cout<<"**** GAME OVER ****"<<endl;
        cout<<endl;
        cout<<"Total progress: 100%"<<endl;
        cout<<endl;
        cout<<"This game was inspired by Dark Dome's 'The Girl in the Window.' Thank you for playing!"<<endl;
    }
        else{
            ...
            cout<<"With the evidence you found, you head to the police station."<<endl;
            cout<<endl;
            cout<<"You are missing the items needed for the investigation, your investigation failed!"<<endl;
            cout<<"ENDING #4: Mission Failed!";
            cout<<endl;
            cout<<"**** GAME OVER ****"<<endl;
            cout<<endl;
            cout<<"Total progress: 100%"<<endl;
